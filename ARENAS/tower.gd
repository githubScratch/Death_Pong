...
@onready var victory_label_1: Label = $CameraPackage/Screens/Player_1_Victory/CenterContainer/VBoxContainer/Label
@onready var victory_label_2: Label = $CameraPackage/Screens/Player_2_Victory/CenterContainer/VBoxContainer/Label
